...
public class LinkToolKit {
	...
	public void showOptions(){
		...
		System.out.println("8.Delete List");
		System.out.println("9.Rotate List by 'n' nodes");
		System.out.println("10.Pair wise swap");
	...
	public void getOption(int opt){
			...
			case 9:
				if(returncount()<1){
					  ...
					  System.out.println("How many nodes are to be rotated");
						rotate(new Scanner(System.in).nextInt());	  
				  }
				break;
